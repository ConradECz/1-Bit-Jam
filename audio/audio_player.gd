...
func play_sound(sound_path: String, volume: float = 0) -> AudioStreamPlayer:
	return play_stream(load(sound_path), volume)

func play_sound_at_point(sound_path: String, position: Vector2, volume: float = 0) -> AudioStreamPlayer2D:
	return play_stream_at_point(load(sound_path), position, volume)

func play_stream(stream : AudioStream, volume : float = 0) -> AudioStreamPlayer:
...
func play_stream_at_point(stream : AudioStream, position: Vector2, volume: float = 0) -> AudioStreamPlayer2D:
...
func play_music(music_path: String, volume: float = 0, looping: bool = true) -> AudioStreamPlayer:
